...
- **Stability chart's explanation moved into its own card** — the wall of text above the chart is now a separate card below it, split into what the score measures (with a worked 0/0.5/1.0 → 100/50/25 scale), what a greyed wedge means, and what each column of the detail table is
